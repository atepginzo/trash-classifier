  ...
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-3xl overflow-hidden
                 ...
                 transition-shadow duration-500 flex flex-col"
    >
      {/* ── Header band + avatar ── */}
      ...
      <div className="px-6 pb-6 flex flex-col flex-1 text-center">
        {/* Name & role */}
        <h3 className="text-xl font-bold text-slate-900 tracking-tight mt-1 mb-0.5">
          {member.name}
        </h3>
        ...
        {/* University info */}
        <div className="space-y-2 pt-4 border-t border-slate-100 mb-4 text-left">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-slate-700 leading-tight">{member.university}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
            ...
            <span className="text-xs text-slate-500 leading-tight">{member.major}</span>
          </div>
        </div>
...
export default function TeamSection() {
  ...
  return (
    <section id="tim" className="relative py-24 sm:py-32 lg:py-40 bg-[#F8FAFC] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-0 -right-32 w-96 h-96 rounded-full bg-violet-100/20 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-5
                           ...
                           text-emerald-700 text-xs font-semibold tracking-widest uppercase">
          ...
          <h2 className="text-[2.2rem] sm:text-[2.8rem] lg:text-[3.2rem]
                         font-extrabold text-slate-900 leading-[1.1] tracking-[-0.025em] mb-4">
            Profil Anggota Tim
          </h2>
              ...
              <div key={role}>
                ...
                >
                  ...
                  <span className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full
                                   text-xs font-bold uppercase tracking-widest border ${cfg.badge}`}>
